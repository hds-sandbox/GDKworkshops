...
Now, imagine this session is the one to do things on the front-end node. You would like one for interactive jobs which will keep being online even if you disconnect.

Detach .....
Create a new session called `srunJobs`.
