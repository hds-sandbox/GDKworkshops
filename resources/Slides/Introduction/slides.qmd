...
:::{.callout-tip}
Use the <kbd>up</kbd> key on the terminal to find the commands you used previously, and press enter when you find the login command
:::

---

When you log in, you are in your private **home folder**. This is denoted by `~` or equivalently `/home/username/`. Your prompt will show something like this:
